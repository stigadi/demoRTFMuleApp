  ...
  stages {
    ...
    stage('deploy-to-rtf') {
      steps {
        ...
        sh "mvn clean package deploy -DmuleDeploy -Dmule.version=4.4.0 -DauthToken=ad65def8-230b-4160-9ff1-0b0f34824bf5 -Drtf.app.name=demo-rtf-cicd-muleapp -Ddeployment.target=rtf-gke-sidd Dbusiness.group.id=b6430f15-51c3-4480-8ed3-917175ef77af -DplatformClientId=eb98819200324dcf86c3405e5e699b0a -DplatformClientSecret=91486e20c81843A5bF596552Aa376f10 -DplatformEnv=dev -Dreplicas=1 -DingressUrl=rtfapi.dev.devoteam.corp -DdeploymentName=demo-rtf-cicd-muleapp"
